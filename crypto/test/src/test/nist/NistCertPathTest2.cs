...
namespace Org.BouncyCastle.Tests.Nist
{
    ...
    public class NistCertPathTest2
    {
        ...
        private static readonly ISet<string> noPolicies = new
#if NET35
            HashSetEx
#else
            HashSet
#endif
            <string>();
        private static readonly ISet<string> anyPolicy = new
#if NET35
            HashSetEx
#else
            HashSet
#endif
            <string>();
        private static readonly ISet<string> nistTestPolicy1 = new
#if NET35
            HashSetEx
#else
            HashSet
#endif
            <string>();
        private static readonly ISet<string> nistTestPolicy2 = new
#if NET35
            HashSetEx
#else
            HashSet
#endif
            <string>();
        private static readonly ISet<string> nistTestPolicy3 = new
#if NET35
            HashSetEx
#else
            HashSet
#endif
            <string>();
        private static readonly ISet<string> nistTestPolicy1And2 = new
#if NET35
            HashSetEx
#else
            HashSet
